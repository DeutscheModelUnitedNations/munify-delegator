...
export default interface PrismaTypes {
    ...
    Paper: {
        ...
        RelationName: "author" | "delegation" | "agendaItem" | "Conference";
        ListRelations: never;
        Relations: {
            author: {
                Shape: User;
