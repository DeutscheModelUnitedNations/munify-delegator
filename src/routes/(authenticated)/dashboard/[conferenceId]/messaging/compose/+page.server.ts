...
export const actions = {
	send: async (event) => {
		...
		const replyUrl = `${event.url.origin}/dashboard/${conferenceId}/messaging/compose?recipientId=${encodeURIComponent(authUser.sub)}&subject=${encodeURIComponent(replySubject)}`;
