			...
			<div class="grid grid-cols-12 grid-rows-[min-content] gap-y-12 p-4 lg:gap-x-12 lg:p-10">
				...
				<section class="card col-span-12 bg-primary text-primary-content shadow-sm xl:col-span-6">
					<div class="card-body pb-0">
						<h2 class="card-title">21,500 USD</h2>
						<a class="link-hover link text-xs">Revenue report →</a>
					</div>
					<tc-column
				...
				<section class="card col-span-12 bg-base-100 shadow-sm xl:col-span-4">
					<div class="card-body">
						...
						<div class="flex items-center gap-10">
							...
							<tc-pie
								class="h-32 w-32 shrink-0 [--shape-color-1:#A838FF] [--shape-color-2:#19D6BF] [--shape-color-3:#3C37FF] [--shape-color-4:#FFBD3C]"
								values="[35,68,22,16]"
								shape-size="30"
								shape-gap="6"
							></tc-pie>
				...
				<section class="card col-span-12 bg-base-100 shadow-sm xl:col-span-4">
					...
					<tc-line
						class="h-full w-full rounded-box [--area-opacity:.2] [--shape-color:#19D6BF]"
				...
				<section class="card col-span-12 bg-base-100 shadow-sm xl:col-span-4">
					...
					<tc-line
						class="h-full w-full rounded-box [--area-opacity:.2] [--shape-color:#A838FF]"
						values="[12,10,12,4,13,16,14,10,12,11,17,18,16,17,20,14,15,13,12,14]"
						min="0"
					></tc-line>
				</section>
			...
			<nav class="flex min-h-screen w-72 flex-col gap-2 overflow-y-auto bg-base-100 px-6 py-10">
				...
				<ul class="menu">
					...
					<li>
						<details>
							<summary>
								<svg data-src="https://unpkg.com/heroicons/20/solid/squares-2x2.svg" class="h-5 w-5"
								></svg>
								Products
							</summary>
							<ul>
					...
					<li>
						<details>
							<summary>
								<svg data-src="https://unpkg.com/heroicons/20/solid/credit-card.svg" class="h-5 w-5"
								></svg>
								Transactions
							</summary>
							<ul>
					...
					<li>
						<a>
							<svg data-src="https://unpkg.com/heroicons/20/solid/chart-pie.svg" class="h-5 w-5"
							></svg>
							Stats
						</a>
					</li>
					<li>
						<a>
							<svg data-src="https://unpkg.com/heroicons/20/solid/document-text.svg" class="h-5 w-5"
							></svg>
							Logs
						</a>
					</li>
